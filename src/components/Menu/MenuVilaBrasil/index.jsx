  ...
  return (
    <div className="menuVilaBrasil">
      ...
      <div className="lista-menu" id="lista-menu">
        ...
        >
          <Link className="link-menu" to="/registrar-aula" onClick={() => handleMenu(1)}>
        ...
        >
          <Link className="link-menu" to="/estudantes" onClick={() => handleMenu(2)}>
            <h3>Estudantes</h3>
          </Link>
        </div>
        <div
        ...
        >
          <Link className="link-menu" to="/financeiro" onClick={() => handleMenu(3)}>
            <h3>Financeiro</h3>
          </Link>
        </div>
      </div>
